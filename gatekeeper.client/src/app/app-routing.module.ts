...
// Portal Components for static routes
import { PortalLayoutComponent } from './portal/layout/portal-layout/portal-layout.component';
import { HomeComponent as PortalHomeComponent } from './portal/home/home/home.component'; // Alias to avoid name clash
import { UserProfileComponent } from './portal/user/user-profile/user-profile.component';
import { UserSettingsComponent } from './portal/user/user-settings/user-settings.component';
import { SessionsComponent } from './portal/user/sessions/sessions.component';
import { InviteComponent } from './portal/user/invite/invite.component';
...
const staticRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', component: PortalHomeComponent }, // Default for /portal
      { path: 'home', component: PortalHomeComponent },
      { path: 'profile', component: UserProfileComponent },
      { path: 'settings', component: UserSettingsComponent },
      { path: 'sessions', component: SessionsComponent },
      { path: 'invite', component: InviteComponent },
      // Dynamic plugin routes will be appended here by the APP_INITIALIZER
    ]
  },
