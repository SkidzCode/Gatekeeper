...
// import { UserProfileComponent } from './user/user-profile/user-profile.component'; // Removed for plugin
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      // { path: 'user/profile', component: UserProfileComponent, canActivate: [DisabledGuardService, AuthGuard] }, // Removed for plugin
